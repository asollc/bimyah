  ...
  const content = (
    ...
    >
      <div className="sticky top-0 z-10 bg-[oklch(0.18_0.04_165)] px-6 pb-3 pt-6 shadow-[0_4px_8px_-4px_rgba(0,0,0,0.6)]">
        <h2 className="mb-3 font-display text-2xl text-[var(--mint)]">
          How to Play BIMYAH!
        </h2>
      ...
      <TabsContent value="multiplayer" className="space-y-4 text-sm leading-relaxed text-white/85">
        ...
        <Section title="Reentry Codes">
          <ul className="list-disc space-y-1 pl-5">
            ...
            <li>If you lose connection or close the game, tap <b>Join with Code</b>, enter the room code, then tap <b>Use Reentry Code</b> to take back your seat — hand, piles, and score intact.</li>
